...
if (!empty($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM attandances WHERE id=$id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($student_id_error) && empty($date_error) && empty($status_error)) {
        ...
        $sql = "UPDATE attandances SET student_id=?, class_id=?, date=?, status=? WHERE id=$id";
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="<?php echo $row['id'] ?>"
                                            <?php echo $student_id == $row['id'] ? 'selected' : '' ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date " id="date" data-target-input="nearest">
                                        <input type="text"
                                            ...
                                            data-target="#date" id="date" name="date" value="<?php echo $date ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="absent" <?php echo $status == 'absent' ? 'selected' : '' ?>>
                                            Absent</option>
                                        <option value="leave" <?php echo $status == 'leave' ? 'selected' : '' ?>>Leave
                                        </option>
                                    </select>
